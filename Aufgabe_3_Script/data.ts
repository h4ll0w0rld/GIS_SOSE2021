namespace Bitte {
    ...
    export let headImageJSON: string = JSON.stringify(imageArray);
    export let bodyImageJSON: string = JSON.stringify(bodyArray);
    export let legImageJSON: string = JSON.stringify(legArray);
